...
macro_rules! impl_transcoding {
  (
    ...
    #[inline]
    #[must_use]
    pub unsafe fn $ca_name(src: &[$src_ty]) -> Vec<$dst_ty> {
      let dst_len = $count_f(src.as_ptr(), src.len());
      let mut dst = vec![0; dst_len];
      $ca_f(src.as_ptr(), src.len(), dst.as_mut_slice().as_mut_ptr());
      dst
    }
...
impl_count!("UTF8", u8, "UTF16", u16, simdutf_utf16_length_from_utf8, count_utf16_from_utf8,);

impl_count!("UTF8", u8, "UTF32", u32, simdutf_utf32_length_from_utf8, count_utf32_from_utf8,);

impl_count!("UTF16-LE", u16, "UTF8", u8, simdutf_utf8_length_from_utf16le, count_utf8_from_utf16le,);

impl_count!("UTF16-LE", u16, "UTF32", u32, simdutf_utf32_length_from_utf16le, count_utf32_from_utf16le,);

impl_count!("UTF16-BE", u16, "UTF8", u8, simdutf_utf8_length_from_utf16be, count_utf8_from_utf16be,);

impl_count!("UTF16-BE", u16, "UTF32", u32, simdutf_utf32_length_from_utf16be, count_utf32_from_utf16be,);

impl_count!("UTF32-LE", u32, "UTF8", u8, simdutf_utf8_length_from_utf32, count_utf8_from_utf32le,);

impl_count!("UTF32-LE", u32, "UTF16", u16, simdutf_utf16_length_from_utf32, count_utf16_from_utf32le,);
